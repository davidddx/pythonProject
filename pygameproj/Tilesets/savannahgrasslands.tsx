...
<tileset version="1.10" tiledversion="1.10.2" name="savannahgrasslands" tilewidth="1384" tileheight="1000" tilecount="12" columns="0">
 ...
 <tile id="6">
  ...
  <image width="256" height="256" source="../tiles/background/detailedtallgrass.png"/>
 </tile>
 <tile id="7" type="scrollingbackground">
  <properties>
   <property name="backgroundtype" type="int" value="4"/>
   <property name="name" value="background"/>
  </properties>
  <image width="1384" height="400" source="../tiles/background/grassland/grass1background.png"/>
 </tile>
 <tile id="8" type="scrollingbackground">
  <properties>
   <property name="backgroundtype" type="int" value="5"/>
   <property name="name" value="background"/>
  </properties>
  <image width="1384" height="600" source="../tiles/background/grassland/grass2background.png"/>
 </tile>
 <tile id="9" type="scrollingbackground">
  <properties>
   <property name="backgroundtype" type="int" value="6"/>
   <property name="name" value="background"/>
  </properties>
  <image width="1384" height="800" source="../tiles/background/grassland/grass3background.png"/>
 </tile>
 <tile id="10" type="scrollingbackground">
  <properties>
   <property name="backgroundtype" type="int" value="7"/>
   <property name="name" value="background"/>
  </properties>
  <image width="1384" height="1000" source="../tiles/background/grassland/grass4background.png"/>
 </tile>
 <tile id="11">
  <properties>
   <property name="backgroundtype" type="int" value="1"/>
